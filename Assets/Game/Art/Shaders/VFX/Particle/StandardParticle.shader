...
Shader "Custom/VFX/ParticleBase"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd][ASEBegin][SingleLineTexture]_MainText("MainText", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode5 = tex2D( _MainText, uv_MainText );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2DNode5.a * IN.ase_color ).rgb;
...
/*ASEBEGIN
Version=18935
0;432;1100;387;725.6653;89.27231;1;True;False
Node;AmplifyShaderEditor.SamplerNode;5;-634.5497,-88.15939;Inherit;True;Property;_MainText;MainText;0;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;4ad5a0f7f27d9ec4089d94d7e95f24c6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;9;-536.2959,105.6408;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-256.2898,85.0192;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;8;-108.5549,82.02155;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-237.117,-73.47461;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;17;-132.6653,222.2277;Inherit;False;BendingFunct;-1;;1;9f240036f760b624cb3b43d3ccda32ab;0;0;1;FLOAT3;0
...
ASEEND*/
//CHKSM=CA748F2FCBA751061BD844AB2B6F7740117DB591